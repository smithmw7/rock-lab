...
export const WORKSHOP_SURFACES = Object.freeze({
  ...
  oak: { family:'wood', label:'Honey oak', short:'Oak', description:'Warm blond grain · rounded knots', roughness:.56, metalness:0, environment:.55, defaults:{woodGrainScale:2,woodGrainStrength:.65,woodKnots:.35,woodWarmth:.65} },
  walnut: { family:'wood', label:'Dark walnut', short:'Walnut', description:'Chocolate grain · warm worn edges', roughness:.43, metalness:0, environment:.65, defaults:{woodGrainScale:2.3,woodGrainStrength:.72,woodKnots:.3,woodWarmth:.55} },
  weatheredWood: { family:'wood', label:'Weathered wood', short:'Old wood', description:'Silvered timber · deep long grain', roughness:.82, metalness:0, environment:.40, defaults:{woodGrainScale:1.7,woodGrainStrength:.8,woodKnots:.45,woodWarmth:.28} },
...
export const WORKSHOP_MATERIAL_FIELDS = Object.freeze({
  ...
  wood:['woodGrainScale','woodGrainStrength','woodKnots','woodWarmth'],
