...
async function gizmoDrag(){
  await page.locator('#tab-scene').click();await numeric('scene-translation-snap',.25);await page.locator('#scene-snap').check();await page.locator('[data-scene-tool="translate"]').click();await page.locator('#scene-frame').click();await advance(600);
